...
console.log(Math.pow(2, 3, 2)); /* Solo toma los primero 2 argumentos, no acepta mas argumentos por que es una potencia simple */
console.log(Math.pow((2 + 2), 2)); 

/* La función Math.sqrt() retorna la raíz cuadrada de un número, que es */

console.log(Math.sqrt(16));
console.log(Math.sqrt(-16)); /* El master pedro dice que las raices no puedenser de valores negativos */
...
const rima = "Profe yo te pregunto, por lo redondo de un cerro, respondeme ahora mismo, ¿Cuantos pelos tiene un perro?"
console.log(rima.indexOf("perro")); /* cuenta todos los caracteres del string y entrega donde comienza la palabra buscada */

/* [...rima].forEach((e,i)=> {console.log(e,i)})  */

console.log(rima.indexOf("Perro".toLowerCase())); /* cuenta todos los caracteres del string y entrega conde comienza la palabra buscada */
...
console.log(rima2.lastIndexOf("Git"));/* ultima aparicion de la coincidencia en este caso 4 caracteres antes de llegar a Git */
console.log(rima2.lastIndexOf("t")); /* ultima aparicion de la coincidencia en este caso 4 caracteres antes de llegar a t */
console.log(rima2.lastIndexOf("h")); /* edvuelve -1 cuando no encuentra la coincidencia del caracter o palabra */
...
const rima4 = "Con un commit guardo mi acción, y el historial gana precisión."

console.log(rima4.startsWith("C"));
console.log(rima4.startsWith("c"));
console.log(rima4.startsWith("Con"));
console.log(rima4.startsWith("con"));
console.log(rima4.startsWith("un"));
console.log(rima4.startsWith("Un"));